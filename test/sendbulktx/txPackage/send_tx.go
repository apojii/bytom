...
func Sendbulktx(threadTxNum int, txBtmNum string, sendAcct string, controlPrograms []string, txidChan chan string) {
	...
	for i := 0; i < threadTxNum; i++ {
		...
		param := []string{sendAcct, "ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff", txBtmNum, receiver}
